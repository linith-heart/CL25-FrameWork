...
#define WINDOW_NAME		"shmup"					// ウインドウのキャプション名
//=============================================================================
// プロトタイプ宣言
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	WNDCLASSEX wcex =			// the window class its self
	{
		sizeof(WNDCLASSEX),
		CS_CLASSDC,
		WndProc,
		...
		NULL,
		CLASS_NAME,		// make a new name for this
		NULL
	};
	HWND hWnd;
	MSG msg;
	...
	// ウィンドウクラスの登録
	RegisterClassEx(&wcex);			// regester as a new thing

									// ウィンドウの作成
	hWnd = CreateWindowEx(0,		// duplacate this part
		CLASS_NAME,
		WINDOW_NAME,
		WS_OVERLAPPEDWINDOW,
		CW_USEDEFAULT,
